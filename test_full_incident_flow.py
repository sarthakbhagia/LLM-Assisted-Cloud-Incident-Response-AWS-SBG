...
class FullIncidentFlowTest:
    def __init__(self):
        ...
        # Configuration
        self.incidents_table = "incidents-dev"
        self.data_lake_bucket = "llm-incident-datalake-889081505756-dev"
        self.service_a_url = "https://0jqdaxn8k1.execute-api.ap-south-1.amazonaws.com/Prod/start"
    ...
    def approve_incident(self, incident_id):
        ...
        try:
            ...
            remediation_function = 'llm-incident-response-RemediationFunction-zzztcK9ZQxk5'
